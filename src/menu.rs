...
fn canva(theme: theme::Theme) {
    ...
    widget::info_widget(logic::Point{x: 275, y: 16}, theme, draw::Text{text: "paste\0", xoffset: 7, big: true, text_color: theme.text, bg_color: theme.secondary_accent});
}
            ...
            if characters_switched {
                match selected_character {
                    ...
                    3 => {
                        ...
                        widget::difficulty_widget(logic::Point{x: 230, y: 90},theme, 1);
                        hiragana::e(logic::Point{x: 245, y: 160}, 0.5, 4, theme.overlay, 0, draw::Fastforwarding{enabled: false, scale: 1.0});
                        hiragana::e(logic::Point{x: 245, y: 155}, 0.5, 4, theme.secondary_accent, 0, draw::Fastforwarding{enabled: false, scale: 1.0});
