...
pub fn page() {
    ...
    'page: loop {
        ...
        if needs_redraw {
            ...
            widget::rect_widget(logic::Rect{x: 220, y: 125, width: 90, height: 105}, theme, 6);
            widget::info_widget(logic::Point{x: 240, y: 120}, theme, draw::Text{text: "clear\0", xoffset: 5, big: true, text_color: theme.accent, bg_color: theme.tertiary_accent});
            widget::info_widget(logic::Point{x: 90, y: 15}, theme, draw::Text{text: "+/-\0", xoffset: 10, big: true, text_color: theme.accent, bg_color: theme.tertiary_accent});
            widget::info_widget(logic::Point{x: 145, y: 15}, theme, draw::Text{text: "EXE\0", xoffset: 10, big: true, text_color: theme.accent, bg_color: theme.tertiary_accent});
            if characters_switched {
                match selected_character {
                    0 => {
                        widget::character_widget(logic::Point{x: 230, y: 25}, theme, draw::Text{text: "A\0", xoffset: 30, big: true, text_color: theme.text, bg_color: theme.accent});
                        widget::difficulty_widget(logic::Point{x: 230, y: 70},theme, 2);
                    ...
                    1 => {
                        widget::character_widget(logic::Point{x: 230, y: 25}, theme, draw::Text{text: "I\0", xoffset: 30, big: true, text_color: theme.text, bg_color: theme.accent});
                        widget::difficulty_widget(logic::Point{x: 230, y: 70},theme, 1);
                    ...
                    2 => {
                        widget::character_widget(logic::Point{x: 230, y: 25}, theme, draw::Text{text: "U\0", xoffset: 30, big: true, text_color: theme.text, bg_color: theme.accent});
                        widget::difficulty_widget(logic::Point{x: 230, y: 70},theme, 2);
                    ...
                    3 => {
                        widget::character_widget(logic::Point{x: 230, y: 25}, theme, draw::Text{text: "E\0", xoffset: 30, big: true, text_color: theme.text, bg_color: theme.accent});
                        widget::difficulty_widget(logic::Point{x: 230, y: 70},theme, 1);
                ...
                match selected_character {
                    0 => {
                        widget::character_widget(logic::Point{x: 230, y: 25}, theme, draw::Text{text: "A\0", xoffset: 30, big: true, text_color: theme.text, bg_color: theme.accent});
                        widget::difficulty_widget(logic::Point{x: 230, y: 70},theme, 4);
                    ...
                    2 => {
                        widget::character_widget(logic::Point{x: 230, y: 25}, theme, draw::Text{text: "U\0", xoffset: 30, big: true, text_color: theme.text, bg_color: theme.accent});
                        widget::difficulty_widget(logic::Point{x: 230, y: 70},theme, 3);
